...
const CREATOR = [
    '/testimonials/creator-1.jpg',
    '/testimonials/creator-2.png',
    '/testimonials/snap-1.jpeg',
    '/testimonials/creator-3.jpg',
    '/testimonials/creator-4.png',
    '/testimonials/creator-5.jpg',
]
...
function ReviewGrid() {
    ...
    const columns = splitArray(CREATOR, 3)
...
export function Reviews() {
    return(
        <MaxWidthWrapper className='relative max-w-5xl'>
            <img aria-hidden='true' src='/phone.jpg' className='absolute select-none xl:block -left-32 top-1/3' alt="reviews-image"/>
